...
/// @notice Send 1 UP token from ETH to Flare via the OFTAdapter
/// @dev Run with: forge script script/SendUpToFlare.s.sol:SendUpToFlare --rpc-url $ETH_RPC --broadcast --account v2-supervaults -vvv
contract SendUpToFlare is Script {
