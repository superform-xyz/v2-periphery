...
###################################################################################
# Deploy SuperVaultExecutor Script
###################################################################################
# Description:
#   Deploys SuperVaultExecutor - session key delegation contract for secondary
#   manager functions on SuperVault strategies.
#
# Usage:
#   ./deploy_supervault_executor.sh <environment> <mode> [account] [chain_id]
#
#   Parameters:
...
#   ./deploy_supervault_executor.sh staging check
#
#   # Check deployment status on specific chain
#   ./deploy_supervault_executor.sh staging check "" 8453
#
#   # Simulate deployment on all staging chains
#   ./deploy_supervault_executor.sh staging simulate
#
#   # Simulate deployment on specific chain
#   ./deploy_supervault_executor.sh staging simulate "" 8453
#
#   # Execute deployment on all staging chains
#   ./deploy_supervault_executor.sh staging execute v2-supervaults
#
#   # Execute deployment on specific chain
#   ./deploy_supervault_executor.sh staging execute v2-supervaults 8453
#
#   # Execute deployment on all prod chains
#   ./deploy_supervault_executor.sh prod execute v2-supervaults
#
# Prerequisites:
...
#   1. Add SuperVaultExecutor as secondary manager on each strategy via
#      SuperVaultAggregator.addSecondaryManager(strategy, executorAddr)
#   2. Grant session keys via the primary manager calling
#      SuperVaultExecutor.grantSessionKey(strategy, sessionKey, expiry)
#
...
deploy_on_chain() {
    ...
    forge_cmd+=" script/DeploySuperVaultExecutor.s.sol:DeploySuperVaultExecutor"
...
main() {
    ...
    log "INFO" "============================================"
    log "INFO" "Deploy SuperVaultExecutor"
    log "INFO" "============================================"
    ...
    log "INFO" "============================================"
    log "INFO" "SuperVaultExecutor deployment completed successfully!"
    log "INFO" "============================================"
}
