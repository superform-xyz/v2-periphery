...
#
# Usage:
#   ./script/run/deploy_up_oft_bsc.sh deploy [account]        # deploy UpOFT, writes address to
#                                                             # script/output/prod/56/BNB-latest.json
#   ./script/run/deploy_up_oft_bsc.sh simulate                # dry-run BSC-side configuration
#   ./script/run/deploy_up_oft_bsc.sh configure [account]
#   ./script/run/deploy_up_oft_bsc.sh simulate-rh             # dry-run RH -> BSC wiring
#   ./script/run/deploy_up_oft_bsc.sh configure-rh [account]
#
...
PY
    ...
    echo ""
    echo "Next: ./script/run/deploy_up_oft_bsc.sh simulate"
    echo "Then: ./script/run/deploy_up_oft_bsc.sh configure"
    echo ""
