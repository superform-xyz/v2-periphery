...
ALLOWED_PERIPHERY_CONTRACTS=("SuperGovernor" "SuperVault" "SuperVaultAggregator" "SuperVaultStrategy" "SuperVaultEscrow" "SuperVaultBatchOperator" "SuperVaultExecutor" "ECDSAPPSOracle" "FixedPriceOracle" "SuperOracle" "SuperOracleL2" "SuperBank" "MorphoBorrowCostOracle" "MorphoLendYieldSourceOracle" "ValidatorBonding")
...
source_network_config() {
    local network_config_file="$SCRIPT_DIR/../utils/networks-production.sh"
