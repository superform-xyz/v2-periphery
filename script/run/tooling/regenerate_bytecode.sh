...
get_contract_source() {
    ...
    case $contract_name in
        ...
        "SuperVaultCounsel") echo "src/SuperVault/SuperVaultCounsel.sol" ;;
        "SuperVaultVetoRegistry") echo "src/SuperVault/SuperVaultVetoRegistry.sol" ;;
