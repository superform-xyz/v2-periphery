...
abstract contract Properties is BeforeAfter, Asserts, ERC7540Properties {
    ...
    // NOTE: Withdrawal properties are more nuanced, as we should ensure that no gain can be had and that losses are
    // imputed to the controller receiving the assets
    ...
    function crytic_erc7540_7_redeem(uint256 amt) public {
        ...
        try superVault.redeem(amt, actor, actor) { }
        catch {
            if (amt > 0 && assets > 0) {
