...
contract SuperGovernorTest is PeripheryHelpers {
    ...
    function setUp() public {
        ...
        superGovernor = new SuperGovernor(sGovernor, governor, governor, oracleManager, governor, guardian, treasury, false);
    ...
    function test_ChangePrimaryManager_RevertsWhenAggregatorNotSet() public {
        ...
        SuperGovernor freshGovernor = new SuperGovernor(freshSGovernor, governor, governor, governor, governor, guardian, treasury, false);
    ...
    function test_HighWaterMarkReset_Revert_AggregatorNotSet() public {
        // Deploy a fresh SuperGovernor instance without setting the aggregator
        address freshSGovernor = _deployAccount(0xFF, "FreshSuperGovernor");
        SuperGovernor freshGovernor = new SuperGovernor(freshSGovernor, governor, governor, governor, governor, governor, treasury, false);
    ...
    function test_ProposeGlobalHooksRoot_RevertsWhenAggregatorNotSet() public {
        ...
        SuperGovernor freshGovernor = new SuperGovernor(freshSGovernor, freshGovernor2, freshGovernor2, freshGovernor2, freshGovernor2, guardian, treasury, false);
