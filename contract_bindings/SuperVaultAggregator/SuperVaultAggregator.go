...
func (_SuperVaultAggregator *SuperVaultAggregatorCaller) MAXSTRATEGIES(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SuperVaultAggregator.contract.Call(opts, &out, "MAX_STRATEGIES")
...
//
// Solidity: function MAX_STRATEGIES() view returns(uint256)
func (_SuperVaultAggregator *SuperVaultAggregatorSession) MAXSTRATEGIES() (*big.Int, error) {
	return _SuperVaultAggregator.Contract.MAXSTRATEGIES(&_SuperVaultAggregator.CallOpts)
}

// MAXSTRATEGIES is a free data retrieval call binding the contract method 0x767f06ae.
//
// Solidity: function MAX_STRATEGIES() view returns(uint256)
func (_SuperVaultAggregator *SuperVaultAggregatorCallerSession) MAXSTRATEGIES() (*big.Int, error) {
	return _SuperVaultAggregator.Contract.MAXSTRATEGIES(&_SuperVaultAggregator.CallOpts)
}
...
//
// Solidity: function updateUnpausePPSTimelock(address strategy, uint256 newTimelock_) returns()
func (_SuperVaultAggregator *SuperVaultAggregatorTransactor) UpdateUnpausePPSTimelock(opts *bind.TransactOpts, strategy common.Address, newTimelock_ *big.Int) (*types.Transaction, error) {
	return _SuperVaultAggregator.contract.Transact(opts, "updateUnpausePPSTimelock", strategy, newTimelock_)
}

// UpdateUnpausePPSTimelock is a paid mutator transaction binding the contract method 0x5b943600.
//
// Solidity: function updateUnpausePPSTimelock(address strategy, uint256 newTimelock_) returns()
func (_SuperVaultAggregator *SuperVaultAggregatorSession) UpdateUnpausePPSTimelock(strategy common.Address, newTimelock_ *big.Int) (*types.Transaction, error) {
	return _SuperVaultAggregator.Contract.UpdateUnpausePPSTimelock(&_SuperVaultAggregator.TransactOpts, strategy, newTimelock_)
}

// UpdateUnpausePPSTimelock is a paid mutator transaction binding the contract method 0x5b943600.
//
// Solidity: function updateUnpausePPSTimelock(address strategy, uint256 newTimelock_) returns()
func (_SuperVaultAggregator *SuperVaultAggregatorTransactorSession) UpdateUnpausePPSTimelock(strategy common.Address, newTimelock_ *big.Int) (*types.Transaction, error) {
	return _SuperVaultAggregator.Contract.UpdateUnpausePPSTimelock(&_SuperVaultAggregator.TransactOpts, strategy, newTimelock_)
}
...
// SuperVaultAggregatorSuperformManagerIterator is returned from FilterSuperformManager and is used to iterate over the raw logs and unpacked data for SuperformManager events raised by the SuperVaultAggregator contract.
type SuperVaultAggregatorSuperformManagerIterator struct {
	Event *SuperVaultAggregatorSuperformManager // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SuperVaultAggregatorSuperformManagerIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SuperVaultAggregatorSuperformManager)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SuperVaultAggregatorSuperformManagerIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SuperVaultAggregatorSuperformManagerIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SuperVaultAggregatorSuperformManager represents a SuperformManager event raised by the SuperVaultAggregator contract.
type SuperVaultAggregatorSuperformManager struct {
	Strategy common.Address
	Manager  common.Address
	Raw      types.Log // Blockchain specific contextual infos
}
...
func (_SuperVaultAggregator *SuperVaultAggregatorFilterer) FilterSuperformManager(opts *bind.FilterOpts, strategy []common.Address, manager []common.Address) (*SuperVaultAggregatorSuperformManagerIterator, error) {
	...
	logs, sub, err := _SuperVaultAggregator.contract.FilterLogs(opts, "SuperformManager", strategyRule, managerRule)
	if err != nil {
		return nil, err
	}
	return &SuperVaultAggregatorSuperformManagerIterator{contract: _SuperVaultAggregator.contract, event: "SuperformManager", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SuperformManager(address indexed strategy, address indexed manager)
func (_SuperVaultAggregator *SuperVaultAggregatorFilterer) WatchSuperformManager(opts *bind.WatchOpts, sink chan<- *SuperVaultAggregatorSuperformManager, strategy []common.Address, manager []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SuperVaultAggregator.contract.WatchLogs(opts, "SuperformManager", strategyRule, managerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SuperVaultAggregatorSuperformManager)
				if err := _SuperVaultAggregator.contract.UnpackLog(event, "SuperformManager", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SuperformManager(address indexed strategy, address indexed manager)
func (_SuperVaultAggregator *SuperVaultAggregatorFilterer) ParseSuperformManager(log types.Log) (*SuperVaultAggregatorSuperformManager, error) {
	event := new(SuperVaultAggregatorSuperformManager)
	if err := _SuperVaultAggregator.contract.UnpackLog(event, "SuperformManager", log); err != nil {
		return nil, err
	}
