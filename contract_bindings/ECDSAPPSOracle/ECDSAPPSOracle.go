...
func (_ECDSAPPSOracle *ECDSAPPSOracleCaller) ValidateProofs0(opts *bind.CallOpts, params IECDSAPPSOracleValidationParams, cachedTotalValidators *big.Int, requiredQuorum *big.Int) error {
	var out []interface{}
	err := _ECDSAPPSOracle.contract.Call(opts, &out, "validateProofs0", params, cachedTotalValidators, requiredQuorum)
...
//
// Solidity: function validateProofs((address,bytes[],uint256,uint256,uint256,uint256,uint256) params, uint256 cachedTotalValidators, uint256 requiredQuorum) view returns()
func (_ECDSAPPSOracle *ECDSAPPSOracleSession) ValidateProofs0(params IECDSAPPSOracleValidationParams, cachedTotalValidators *big.Int, requiredQuorum *big.Int) error {
	return _ECDSAPPSOracle.Contract.ValidateProofs0(&_ECDSAPPSOracle.CallOpts, params, cachedTotalValidators, requiredQuorum)
}

// ValidateProofs0 is a free data retrieval call binding the contract method 0xc5bd4aab.
//
// Solidity: function validateProofs((address,bytes[],uint256,uint256,uint256,uint256,uint256) params, uint256 cachedTotalValidators, uint256 requiredQuorum) view returns()
func (_ECDSAPPSOracle *ECDSAPPSOracleCallerSession) ValidateProofs0(params IECDSAPPSOracleValidationParams, cachedTotalValidators *big.Int, requiredQuorum *big.Int) error {
	return _ECDSAPPSOracle.Contract.ValidateProofs0(&_ECDSAPPSOracle.CallOpts, params, cachedTotalValidators, requiredQuorum)
}
