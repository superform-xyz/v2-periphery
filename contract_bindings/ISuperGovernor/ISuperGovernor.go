...
func (_ISuperGovernor *ISuperGovernorCaller) UNPAUSERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _ISuperGovernor.contract.Call(opts, &out, "UNPAUSER_ROLE")
...
//
// Solidity: function UNPAUSER_ROLE() view returns(bytes32)
func (_ISuperGovernor *ISuperGovernorSession) UNPAUSERROLE() ([32]byte, error) {
	return _ISuperGovernor.Contract.UNPAUSERROLE(&_ISuperGovernor.CallOpts)
}

// UNPAUSERROLE is a free data retrieval call binding the contract method 0xfb1bb9de.
//
// Solidity: function UNPAUSER_ROLE() view returns(bytes32)
func (_ISuperGovernor *ISuperGovernorCallerSession) UNPAUSERROLE() ([32]byte, error) {
	return _ISuperGovernor.Contract.UNPAUSERROLE(&_ISuperGovernor.CallOpts)
}
...
func (_ISuperGovernor *ISuperGovernorCaller) GetProtectedKeepers(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _ISuperGovernor.contract.Call(opts, &out, "getProtectedKeepers")
...
//
// Solidity: function getProtectedKeepers() view returns(address[])
func (_ISuperGovernor *ISuperGovernorSession) GetProtectedKeepers() ([]common.Address, error) {
	return _ISuperGovernor.Contract.GetProtectedKeepers(&_ISuperGovernor.CallOpts)
}

// GetProtectedKeepers is a free data retrieval call binding the contract method 0x84570ebf.
//
// Solidity: function getProtectedKeepers() view returns(address[])
func (_ISuperGovernor *ISuperGovernorCallerSession) GetProtectedKeepers() ([]common.Address, error) {
	return _ISuperGovernor.Contract.GetProtectedKeepers(&_ISuperGovernor.CallOpts)
}
...
func (_ISuperGovernor *ISuperGovernorCaller) GetProtectedKeepersCount(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ISuperGovernor.contract.Call(opts, &out, "getProtectedKeepersCount")
...
//
// Solidity: function getProtectedKeepersCount() view returns(uint256)
func (_ISuperGovernor *ISuperGovernorSession) GetProtectedKeepersCount() (*big.Int, error) {
	return _ISuperGovernor.Contract.GetProtectedKeepersCount(&_ISuperGovernor.CallOpts)
}

// GetProtectedKeepersCount is a free data retrieval call binding the contract method 0xb1c0374d.
//
// Solidity: function getProtectedKeepersCount() view returns(uint256)
func (_ISuperGovernor *ISuperGovernorCallerSession) GetProtectedKeepersCount() (*big.Int, error) {
	return _ISuperGovernor.Contract.GetProtectedKeepersCount(&_ISuperGovernor.CallOpts)
}
...
func (_ISuperGovernor *ISuperGovernorCaller) IsProtectedKeeper(opts *bind.CallOpts, keeper common.Address) (bool, error) {
	var out []interface{}
	err := _ISuperGovernor.contract.Call(opts, &out, "isProtectedKeeper", keeper)
...
//
// Solidity: function isProtectedKeeper(address keeper) view returns(bool)
func (_ISuperGovernor *ISuperGovernorSession) IsProtectedKeeper(keeper common.Address) (bool, error) {
	return _ISuperGovernor.Contract.IsProtectedKeeper(&_ISuperGovernor.CallOpts, keeper)
}

// IsProtectedKeeper is a free data retrieval call binding the contract method 0x1e1c3d38.
//
// Solidity: function isProtectedKeeper(address keeper) view returns(bool)
func (_ISuperGovernor *ISuperGovernorCallerSession) IsProtectedKeeper(keeper common.Address) (bool, error) {
	return _ISuperGovernor.Contract.IsProtectedKeeper(&_ISuperGovernor.CallOpts, keeper)
}
...
func (_ISuperGovernor *ISuperGovernorTransactor) RegisterProtectedKeeper(opts *bind.TransactOpts, keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.contract.Transact(opts, "registerProtectedKeeper", keeper)
}

// RegisterProtectedKeeper is a paid mutator transaction binding the contract method 0x50151492.
//
// Solidity: function registerProtectedKeeper(address keeper) returns()
func (_ISuperGovernor *ISuperGovernorSession) RegisterProtectedKeeper(keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.Contract.RegisterProtectedKeeper(&_ISuperGovernor.TransactOpts, keeper)
}

// RegisterProtectedKeeper is a paid mutator transaction binding the contract method 0x50151492.
//
// Solidity: function registerProtectedKeeper(address keeper) returns()
func (_ISuperGovernor *ISuperGovernorTransactorSession) RegisterProtectedKeeper(keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.Contract.RegisterProtectedKeeper(&_ISuperGovernor.TransactOpts, keeper)
}
...
func (_ISuperGovernor *ISuperGovernorTransactor) UnregisterProtectedKeeper(opts *bind.TransactOpts, keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.contract.Transact(opts, "unregisterProtectedKeeper", keeper)
}

// UnregisterProtectedKeeper is a paid mutator transaction binding the contract method 0xa390ad1e.
//
// Solidity: function unregisterProtectedKeeper(address keeper) returns()
func (_ISuperGovernor *ISuperGovernorSession) UnregisterProtectedKeeper(keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.Contract.UnregisterProtectedKeeper(&_ISuperGovernor.TransactOpts, keeper)
}

// UnregisterProtectedKeeper is a paid mutator transaction binding the contract method 0xa390ad1e.
//
// Solidity: function unregisterProtectedKeeper(address keeper) returns()
func (_ISuperGovernor *ISuperGovernorTransactorSession) UnregisterProtectedKeeper(keeper common.Address) (*types.Transaction, error) {
	return _ISuperGovernor.Contract.UnregisterProtectedKeeper(&_ISuperGovernor.TransactOpts, keeper)
}
