...
| 24h `maxStaleness` vs 2h operations | cap guard freshness | configuration: the deploy runbook should set `maxStaleness` close to the reporting cadence (≤ a few hours), not the 24h ceiling — RECOMMENDATION |
