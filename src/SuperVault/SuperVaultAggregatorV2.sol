...
// Superform
import { SuperVaultV2 as SuperVault } from "./SuperVaultV2.sol";
import { SuperVaultStrategyV2 as SuperVaultStrategy } from "./SuperVaultStrategyV2.sol";
...
/// @title SuperVaultAggregatorV2
/// @author Superform Labs
/// @notice Registry and PPS oracle for all SuperVaults
/// @dev V2: uses AssetMetadataLibV2 (no code.length guard) to support B20 precompile assets.
///      Also deploys SuperVaultV2 and SuperVaultStrategyV2 instances which support
///      ERC721/ERC1155 receiver callbacks, ERC1271 signature validation, and ERC165 interface detection.
contract SuperVaultAggregatorV2 is ISuperVaultAggregator {
