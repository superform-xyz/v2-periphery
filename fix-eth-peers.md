# Set ETH OFT Adapter Peers for HyperEVM and Flare

## Summary

The ETH UpOFTAdapter (`0x722ff7C0665F4b1823c9C4cFcDF73A43de5865BD`) needs peers set for HyperEVM and Flare.

## Transaction 1: Set HyperEVM Peer

**To:** `0x722ff7C0665F4b1823c9C4cFcDF73A43de5865BD` (ETH UpOFTAdapter)
...
```
cast call 0x722ff7C0665F4b1823c9C4cFcDF73A43de5865BD "peers(uint32)(bytes32)" 30367 --rpc-url <ETH_RPC>
cast call 0x722ff7C0665F4b1823c9C4cFcDF73A43de5865BD "peers(uint32)(bytes32)" 30295 --rpc-url <ETH_RPC>
```
